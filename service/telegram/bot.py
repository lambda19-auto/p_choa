...
async def cmd_about(message: Message) -> None:
    ...
    await message.answer(
        'Я нейро-финансист в торговой компании. В мои обязанности входит ведение журнала операции для ОДДС. А также написание аналитических записок по просьбам руководства.\n\n'
        ...
        'Ссылки на заполняемые таблицы:\n'
        '<a href="https://docs.google.com/spreadsheets/d/1ySCtMGcsTC0u5ZqmjNkZbkODc0snbDkHPv3YO6HNvgw/edit?usp=sharing">журнал операции</a>\n'
        '<a href="https://docs.google.com/spreadsheets/d/1V8mnswU4ctHoEcazE9HFXooN_DAyqBCK38YexgOTkSQ/edit?usp=drive_link">ОДДС</a>'
    )
